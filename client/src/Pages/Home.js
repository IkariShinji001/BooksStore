        ...
        <div className="w-screen bg-primary-blue h-auto">
            ...
            <div className="bg-[#F4F8FF] pt-20">
                <div className="h-auto mx-auto max-w-screen-xl flex">
                    <div data-aos="fade-right" className="w-4/12 flex flex-col relative justify-center">
                        ...
                        <div className="w-5/12 flex justify-between text-secondary-yellow mt-4 items-center">
                            ...
                            <i className="fa-solid fa-circle"></i>
                            <i className="fa-solid fa-circle"></i>
                            <i className="fa-solid fa-circle-half-stroke"></i> <p className="font-cardo text-primary-blue text-lg ml-2 font-bold">(4.5/5)</p>
                        </div>
                        <p className="text-primary-blue mt-2">Overall Customer Ratings</p>
                    </div>

                    <div data-aos="fade-down" className="w-4/12 h-4/5 flex flex-col gap-6 py-32">
                        <TestimonialReader />

                        <TestimonialReader />
                    </div>

                    <div data-aos="fade-up" className="flex flex-col w-3/12 justify-center items-center ml-14">
                        <TestimonialReader />
                    </div>
                </div>
            </div>
